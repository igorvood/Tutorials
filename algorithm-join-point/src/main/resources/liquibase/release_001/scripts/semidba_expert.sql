...
create any context, create any library, create library,
--
...
drop any type, drop any view, drop public synonym,
drop any context, flashback any table, global query rewrite,
--
