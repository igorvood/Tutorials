...
create session, create synonym, create table, create trigger, create type, create user,
create view, delete any table, create any context, CREATE ANY EDITION, CREATE ANY LIBRARY,
create database link, create library,
--
drop any index, drop any indextype, drop any library, drop any materialized view,
drop any procedure, drop any sequence, drop any synonym, drop any table, drop any trigger,
drop any type, drop any view, drop public synonym, drop user, drop any cluster,
drop any context, drop any edition,
--
...
--
select any sequence, select any table, update any table, change notification
--
to semidba_master
/
