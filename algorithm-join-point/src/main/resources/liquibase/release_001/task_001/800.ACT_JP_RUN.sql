...
(
    ...
    constraint act_jp_run_runner_fk foreign key (runner_id, runner_jp, runner_flow, is_async_run)
...
---
    ...
    constraint act_jp_run_pk primary key (runner_id, runner_jp, runner_flow, runnable_id, runnable_jp,
                                          runnable_flow) using index tablespace jp_idx
)
/
create index act_jp_run_runner_i on act_jp_run (runner_id, runner_jp, runner_flow) tablespace jp_idx
/
